...
"}"));
        ...
        tip_lb->setStyleSheet(QString::fromUtf8("border-image: url(/res/tiplose.png);"));
        ...
        close_lb->setStyleSheet(QString::fromUtf8("border-image: url(/res/tiplose.png);"));
