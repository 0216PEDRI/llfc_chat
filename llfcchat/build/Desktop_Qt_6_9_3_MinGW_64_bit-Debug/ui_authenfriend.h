...
public:
    ...
    void setupUi(QDialog *AuthenFriend)
    {
        ...
        scrollcontent->setGeometry(QRect(0, 0, 400, 498));
        ...
        verticalSpacer_2 = new QSpacerItem(20, 82, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
